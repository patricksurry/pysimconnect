...
# Receive data types
RECV_ID = ENUM_T
RECV_ID_NULL = ENUM_T(0x00)
RECV_ID_EXCEPTION = ENUM_T(0x01)
RECV_ID_OPEN = ENUM_T(0x02)
RECV_ID_QUIT = ENUM_T(0x03)
RECV_ID_EVENT = ENUM_T(0x04)
RECV_ID_EVENT_OBJECT_ADDREMOVE = ENUM_T(0x05)
RECV_ID_EVENT_FILENAME = ENUM_T(0x06)
RECV_ID_EVENT_FRAME = ENUM_T(0x07)
RECV_ID_SIMOBJECT_DATA = ENUM_T(0x08)
RECV_ID_SIMOBJECT_DATA_BYTYPE = ENUM_T(0x09)
RECV_ID_WEATHER_OBSERVATION = ENUM_T(0x0A)
RECV_ID_CLOUD_STATE = ENUM_T(0x0B)
RECV_ID_ASSIGNED_OBJECT_ID = ENUM_T(0x0C)
RECV_ID_RESERVED_KEY = ENUM_T(0x0D)
RECV_ID_CUSTOM_ACTION = ENUM_T(0x0E)
RECV_ID_SYSTEM_STATE = ENUM_T(0x0F)
RECV_ID_CLIENT_DATA = ENUM_T(0x10)
RECV_ID_EVENT_WEATHER_MODE = ENUM_T(0x11)
RECV_ID_AIRPORT_LIST = ENUM_T(0x12)
RECV_ID_VOR_LIST = ENUM_T(0x13)
RECV_ID_NDB_LIST = ENUM_T(0x14)
RECV_ID_WAYPOINT_LIST = ENUM_T(0x15)
RECV_ID_EVENT_MULTIPLAYER_SERVER_STARTED = ENUM_T(0x16)
RECV_ID_EVENT_MULTIPLAYER_CLIENT_STARTED = ENUM_T(0x17)
RECV_ID_EVENT_MULTIPLAYER_SESSION_ENDED = ENUM_T(0x18)
RECV_ID_EVENT_RACE_END = ENUM_T(0x19)
RECV_ID_EVENT_RACE_LAP = ENUM_T(0x1A)
...
# Data data types
DATATYPE = ENUM_T
DATATYPE_INVALID = ENUM_T(0x00)   # invalid data type
DATATYPE_INT32 = ENUM_T(0x01)   # 32-bit integer number
DATATYPE_INT64 = ENUM_T(0x02)   # 64-bit integer number
DATATYPE_FLOAT32 = ENUM_T(0x03)   # 32-bit floating-point number (float)
DATATYPE_FLOAT64 = ENUM_T(0x04)   # 64-bit floating-point number (double)
DATATYPE_STRING8 = ENUM_T(0x05)   # 8-byte string
DATATYPE_STRING32 = ENUM_T(0x06)   # 32-byte string
DATATYPE_STRING64 = ENUM_T(0x07)   # 64-byte string
DATATYPE_STRING128 = ENUM_T(0x08)   # 128-byte string
DATATYPE_STRING256 = ENUM_T(0x09)   # 256-byte string
DATATYPE_STRING260 = ENUM_T(0x0A)   # 260-byte string
DATATYPE_STRINGV = ENUM_T(0x0B)   # variable-length string

DATATYPE_INITPOSITION = ENUM_T(0x0C)   # see SIMCONNECT_DATA_INITPOSITION
DATATYPE_MARKERSTATE = ENUM_T(0x0D)   # see SIMCONNECT_DATA_MARKERSTATE
DATATYPE_WAYPOINT = ENUM_T(0x0E)   # see SIMCONNECT_DATA_WAYPOINT
DATATYPE_LATLONALT = ENUM_T(0x0F)   # see SIMCONNECT_DATA_LATLONALT
DATATYPE_XYZ = ENUM_T(0x10)   # see SIMCONNECT_DATA_XYZ

DATATYPE_MAX = ENUM_T(0x11)   # enum limit


# Exception error types
EXCEPTION = ENUM_T
EXCEPTION_NONE = ENUM_T(0x00)

EXCEPTION_ERROR = ENUM_T(0x01)
EXCEPTION_SIZE_MISMATCH = ENUM_T(0x02)
EXCEPTION_UNRECOGNIZED_ID = ENUM_T(0x03)
EXCEPTION_UNOPENED = ENUM_T(0x04)
EXCEPTION_VERSION_MISMATCH = ENUM_T(0x05)
EXCEPTION_TOO_MANY_GROUPS = ENUM_T(0x06)
EXCEPTION_NAME_UNRECOGNIZED = ENUM_T(0x07)
EXCEPTION_TOO_MANY_EVENT_NAMES = ENUM_T(0x08)
EXCEPTION_EVENT_ID_DUPLICATE = ENUM_T(0x09)
EXCEPTION_TOO_MANY_MAPS = ENUM_T(0x0A)
EXCEPTION_TOO_MANY_OBJECTS = ENUM_T(0x0B)
EXCEPTION_TOO_MANY_REQUESTS = ENUM_T(0x0C)
EXCEPTION_WEATHER_INVALID_PORT = ENUM_T(0x0D)
EXCEPTION_WEATHER_INVALID_METAR = ENUM_T(0x0E)
EXCEPTION_WEATHER_UNABLE_TO_GET_OBSERVATION = ENUM_T(0x0F)
EXCEPTION_WEATHER_UNABLE_TO_CREATE_STATION = ENUM_T(0x10)
EXCEPTION_WEATHER_UNABLE_TO_REMOVE_STATION = ENUM_T(0x11)
EXCEPTION_INVALID_DATA_TYPE = ENUM_T(0x12)
EXCEPTION_INVALID_DATA_SIZE = ENUM_T(0x13)
EXCEPTION_DATA_ERROR = ENUM_T(0x14)
EXCEPTION_INVALID_ARRAY = ENUM_T(0x15)
EXCEPTION_CREATE_OBJECT_FAILED = ENUM_T(0x16)
EXCEPTION_LOAD_FLIGHTPLAN_FAILED = ENUM_T(0x17)
EXCEPTION_OPERATION_INVALID_FOR_OBJECT_TYPE = ENUM_T(0x18)
EXCEPTION_ILLEGAL_OPERATION = ENUM_T(0x19)
EXCEPTION_ALREADY_SUBSCRIBED = ENUM_T(0x1A)
EXCEPTION_INVALID_ENUM = ENUM_T(0x1B)
EXCEPTION_DEFINITION_ERROR = ENUM_T(0x1C)
EXCEPTION_DUPLICATE_ID = ENUM_T(0x1D)
EXCEPTION_DATUM_ID = ENUM_T(0x1E)
EXCEPTION_OUT_OF_BOUNDS = ENUM_T(0x1F)
EXCEPTION_ALREADY_CREATED = ENUM_T(0x20)
EXCEPTION_OBJECT_OUTSIDE_REALITY_BUBBLE = ENUM_T(0x21)
EXCEPTION_OBJECT_CONTAINER = ENUM_T(0x22)
EXCEPTION_OBJECT_AI = ENUM_T(0x23)
EXCEPTION_OBJECT_ATC = ENUM_T(0x24)
EXCEPTION_OBJECT_SCHEDULE = ENUM_T(0x25)


# Object types
SIMOBJECT_TYPE = ENUM_T
SIMOBJECT_TYPE_USER = ENUM_T(0x00)
SIMOBJECT_TYPE_ALL = ENUM_T(0x01)
SIMOBJECT_TYPE_AIRCRAFT = ENUM_T(0x02)
SIMOBJECT_TYPE_HELICOPTER = ENUM_T(0x03)
SIMOBJECT_TYPE_BOAT = ENUM_T(0x04)
SIMOBJECT_TYPE_GROUND = ENUM_T(0x05)


# EventState values
STATE = ENUM_T
STATE_OFF = ENUM_T(0x00)
STATE_ON = ENUM_T(0x01)


# Object Data Request Period values
PERIOD = ENUM_T
PERIOD_NEVER = ENUM_T(0x00)
PERIOD_ONCE = ENUM_T(0x01)
PERIOD_VISUAL_FRAME = ENUM_T(0x02)
PERIOD_SIM_FRAME = ENUM_T(0x03)
PERIOD_SECOND = ENUM_T(0x04)



MISSION_END = ENUM_T
MISSION_FAILED = ENUM_T(0x00)
MISSION_CRASHED = ENUM_T(0x01)
MISSION_SUCCEEDED = ENUM_T(0x02)


# ClientData Request Period values
CLIENT_DATA_PERIOD = ENUM_T
CLIENT_DATA_PERIOD_NEVER = ENUM_T(0x00)
CLIENT_DATA_PERIOD_ONCE = ENUM_T(0x01)
CLIENT_DATA_PERIOD_VISUAL_FRAME = ENUM_T(0x02)
CLIENT_DATA_PERIOD_ON_SET = ENUM_T(0x03)
CLIENT_DATA_PERIOD_SECOND = ENUM_T(0x04)


TEXT_TYPE = ENUM_T
TEXT_TYPE_SCROLL_BLACK = ENUM_T(0x00)
TEXT_TYPE_SCROLL_WHITE = ENUM_T(0x01)
TEXT_TYPE_SCROLL_RED = ENUM_T(0x02)
TEXT_TYPE_SCROLL_GREEN = ENUM_T(0x03)
TEXT_TYPE_SCROLL_BLUE = ENUM_T(0x04)
TEXT_TYPE_SCROLL_YELLOW = ENUM_T(0x05)
TEXT_TYPE_SCROLL_MAGENTA = ENUM_T(0x06)
TEXT_TYPE_SCROLL_CYAN = ENUM_T(0x07)
TEXT_TYPE_PRINT_BLACK = ENUM_T(0x100)
TEXT_TYPE_PRINT_WHITE = ENUM_T(0x101)
TEXT_TYPE_PRINT_RED = ENUM_T(0x102)
TEXT_TYPE_PRINT_GREEN = ENUM_T(0x103)
TEXT_TYPE_PRINT_BLUE = ENUM_T(0x104)
TEXT_TYPE_PRINT_YELLOW = ENUM_T(0x105)
TEXT_TYPE_PRINT_MAGENTA = ENUM_T(0x106)
TEXT_TYPE_PRINT_CYAN = ENUM_T(0x107)
TEXT_TYPE_MENU = ENUM_T(0x200)


TEXT_RESULT = ENUM_T
TEXT_RESULT_MENU_SELECT_1 = ENUM_T(0x00)
TEXT_RESULT_MENU_SELECT_2 = ENUM_T(0x01)
TEXT_RESULT_MENU_SELECT_3 = ENUM_T(0x02)
TEXT_RESULT_MENU_SELECT_4 = ENUM_T(0x03)
TEXT_RESULT_MENU_SELECT_5 = ENUM_T(0x04)
TEXT_RESULT_MENU_SELECT_6 = ENUM_T(0x05)
TEXT_RESULT_MENU_SELECT_7 = ENUM_T(0x06)
TEXT_RESULT_MENU_SELECT_8 = ENUM_T(0x07)
TEXT_RESULT_MENU_SELECT_9 = ENUM_T(0x08)
TEXT_RESULT_MENU_SELECT_10 = ENUM_T(0x09)
TEXT_RESULT_DISPLAYED = ENUM_T(0x10000)
TEXT_RESULT_QUEUED = ENUM_T(0x10001)
TEXT_RESULT_REMOVED = ENUM_T(0x10002)
TEXT_RESULT_REPLACED = ENUM_T(0x10003)
TEXT_RESULT_TIMEOUT = ENUM_T(0x10004)


WEATHER_MODE = ENUM_T
WEATHER_MODE_THEME = ENUM_T(0x00)
WEATHER_MODE_RWW = ENUM_T(0x01)
WEATHER_MODE_CUSTOM = ENUM_T(0x02)
WEATHER_MODE_GLOBAL = ENUM_T(0x03)


FACILITY_LIST_TYPE = ENUM_T
FACILITY_LIST_TYPE_AIRPORT = ENUM_T(0x00)
FACILITY_LIST_TYPE_WAYPOINT = ENUM_T(0x01)
FACILITY_LIST_TYPE_NDB = ENUM_T(0x02)
FACILITY_LIST_TYPE_VOR = ENUM_T(0x03)
FACILITY_LIST_TYPE_COUNT = ENUM_T(0x04)   # invalid
